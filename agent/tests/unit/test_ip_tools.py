"""Unit tests for jiki_agent.skills.ip.tools module.
...
from jiki_agent.skills.ip.tools import LookupIpInput, lookup_ip
...
class TestLookupIpSuccess:
    ...
    async def test_ipv4_lookup(self):
        ...
        with patch("jiki_agent.skills.ip.tools.httpx.AsyncClient", return_value=mock_client):
