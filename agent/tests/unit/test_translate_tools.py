"""Unit tests for starnion_agent.skills.translate.tools module.
...
from starnion_agent.skills.translate.tools import (
    SUPPORTED_LANGS,
    TranslateTextInput,
...
def _patch_gemini(content: str = "번역 결과입니다."):
    ...
    return patch(
        "starnion_agent.skills.translate.tools.ChatGoogleGenerativeAI",
...
class TestTranslateText:
    @pytest.mark.asyncio
    @patch("starnion_agent.skills.translate.tools.settings")
