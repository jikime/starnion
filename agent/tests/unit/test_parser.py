...
class TestExtractTextFromDoc:
    ...
    def test_docx_with_doc_extension(self):
        ...
        from starnion_agent.document.generator import generate_docx
        from starnion_agent.document.parser import extract_text_from_doc
...
class TestExtractTextFromXls:
    ...
    def test_xlsx_with_xls_extension(self):
        ...
        from starnion_agent.document.generator import generate_xlsx
        from starnion_agent.document.parser import extract_text_from_xls
...
class TestExtractTextFromPpt:
    ...
    def test_old_ppt_returns_fallback(self):
        ...
        from starnion_agent.document.parser import extract_text_from_ppt
