"""Unit tests for jiki_agent.skills.memo.tools module.
...
from jiki_agent.skills.memo.tools import (
    DeleteMemoInput,
    ListMemosInput,
    SaveMemoInput,
    delete_memo,
...
class TestSaveMemo:
    ...
    @pytest.mark.asyncio
    @patch("jiki_agent.skills.memo.tools.knowledge_repo")
    @patch("jiki_agent.skills.memo.tools.get_pool")
