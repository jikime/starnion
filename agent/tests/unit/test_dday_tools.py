"""Unit tests for starnion_agent.skills.dday.tools module.
...
from starnion_agent.skills.dday.tools import (
    DeleteDdayInput,
    ListDdaysInput,
    SetDdayInput,
    delete_dday,
...
class TestSetDday:
    ...
    @pytest.mark.asyncio
    @patch("starnion_agent.skills.dday.tools.knowledge_repo")
    @patch("starnion_agent.skills.dday.tools.get_pool")
