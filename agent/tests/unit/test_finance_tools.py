"""Unit tests for starpion_agent.tools.finance module.
...
from starpion_agent.context import get_current_user, set_current_user
from starpion_agent.skills.finance.tools import (
...
class TestSaveFinanceTool:
    ...
    @pytest.mark.asyncio
    @patch("starpion_agent.skills.finance.tools.finance_repo")
    @patch("starpion_agent.skills.finance.tools.get_pool")
