"""Unit tests for jiki_agent.skills.summarize.tools module.
...
from jiki_agent.skills.summarize.tools import (
    SummarizeTextInput,
    SummarizeUrlInput,
    _STYLE_INSTRUCTIONS,
...
def _patch_httpx(mock_response=None, side_effect=None):
    ...
    return patch(
        "jiki_agent.skills.summarize.tools.httpx.AsyncClient",
...
def _patch_gemini(content: str = "요약 결과입니다."):
    ...
    return patch(
        "jiki_agent.skills.summarize.tools.ChatGoogleGenerativeAI",
...
class TestSummarizeUrl:
    @pytest.mark.asyncio
    @patch("jiki_agent.skills.summarize.tools.settings")
    ...
    @pytest.mark.asyncio
    @patch("jiki_agent.skills.summarize.tools._extract_readable_text", return_value="")
    @patch("jiki_agent.skills.summarize.tools.settings")
    ...
    @pytest.mark.asyncio
    @patch("jiki_agent.skills.summarize.tools._extract_readable_text")
    @patch("jiki_agent.skills.summarize.tools.settings")
