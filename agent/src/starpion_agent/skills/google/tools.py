...
from starpion_agent.db.repositories import google as google_repo
from starpion_agent.skills.google.api import NOT_LINKED_MSG, get_google_service
...
async def google_drive_upload(
    ...
    from starpion_agent.document.parser import fetch_file  # type: ignore[import-not-found]
