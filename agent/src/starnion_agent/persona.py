...
PROMPT_I18N: dict[str, dict[str, str]] = {
    "ko": {
        ...
        "tool_rules_body": (
            ...
            "📌 의도 인식: 사용자가 구어체나 줄임말을 사용해도 동일하게 도구를 호출하세요. "
            "예) '메모해' = '메모해줘' = '적어' = '기록해' = '기억해' = '저장해' → save_memo 호출. "
            "'써줘', '남겨줘', '노트해', '이거 메모해' 등 모두 동일하게 처리하세요. "
            "정확한 단어가 아니어도 저장·기록 의도가 있으면 반드시 해당 도구를 호출하세요."
        ),
