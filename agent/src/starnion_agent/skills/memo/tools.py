...
async def save_memo(
    ...
    """메모·노트·기록 저장. 사용자가 무언가를 적거나 기억하거나 저장하길 원하면 반드시 호출.

    한국어 트리거 (구어체 포함):
      '메모해', '메모해줘', '메모해둬', '메모해놔', '메모 남겨줘', '메모 좀 해줘',
      '적어', '적어줘', '적어둬', '적어놔', '써줘', '써놔', '써둬',
      '기록해', '기록해줘', '기록해둬', '남겨줘', '남겨둬',
      '기억해', '기억해줘', '기억해둬', '저장해', '저장해줘',
      '노트해', '노트해줘', '이거 메모해', '이거 적어', '이것 좀 메모해'
    영어: 'note this', 'save a memo', 'jot this down', 'write this down', 'remember this'
    일본어: 'メモして', 'メモしておいて', '書き留めて' | 중국어: '记下来', '备忘录', '记录一下'
    """
