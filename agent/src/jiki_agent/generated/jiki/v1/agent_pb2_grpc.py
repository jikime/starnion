...
from jiki.v1 import agent_pb2 as jiki_dot_v1_dot_agent__pb2
...
if _version_not_supported:
    raise RuntimeError(
        ...
        + ' but the generated code in jiki/v1/agent_pb2_grpc.py depends on'
...
def add_AgentServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'jiki.v1.AgentService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('jiki.v1.AgentService', rpc_method_handlers)
