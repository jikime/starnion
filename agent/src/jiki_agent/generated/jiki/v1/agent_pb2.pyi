...
class ChatRequest(_message.Message):
    __slots__ = ("user_id", "message", "model", "file")
    ...
    model: str
    file: FileInput
    def __init__(self, user_id: _Optional[str] = ..., message: _Optional[str] = ..., model: _Optional[str] = ..., file: _Optional[_Union[FileInput, _Mapping]] = ...) -> None: ...

class ChatResponse(_message.Message):
    __slots__ = ("content", "type", "tool_name", "tool_result")
    ...
    tool_name: str
    tool_result: str
    def __init__(self, content: _Optional[str] = ..., type: _Optional[_Union[ResponseType, str]] = ..., tool_name: _Optional[str] = ..., tool_result: _Optional[str] = ...) -> None: ...
