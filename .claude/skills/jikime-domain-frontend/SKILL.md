...
Design tokens, CVA variants, Compound components, Accessibility patterns.

### State Management

Zustand for simple global state, Redux Toolkit for complex state, React Context for tree-scoped state, Pinia for Vue applications.

### Performance Optimization

Code splitting with dynamic imports, Image optimization with next/image, Memoization with useMemo and useCallback, Virtualization for large lists.

---

## Works Well With

- jikime-domain-backend - Full-stack development
- jikime-library-shadcn - Component library integration
- jikime-lang-typescript - TypeScript patterns
- jikime-workflow-testing - Frontend testing
- jikime-foundation-core - Core architectural principles
