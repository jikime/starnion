---
name: "jikime-foundation-philosopher"
...
### Integration with JikiME Workflow

SPEC Phase Integration:
- Apply Assumption Audit during /jikime:1-plan
...
- backend: Technology selection decisions
- frontend: Architecture and framework choices
- backend: Schema design trade-offs
- manager-quality: Code review bias checking

Skills:
- jikime-foundation-core: Integration with TRUST 5 and SPEC workflow
- jikime-workflow-spec: Assumption documentation in SPEC format
- jikime-domain-backend: Technology-specific trade-off criteria
- jikime-domain-frontend: UI/UX decision frameworks

Commands:
- /jikime:1-plan: Apply Philosopher Framework during specification
- /jikime:2-run: Reference documented trade-offs during implementation
