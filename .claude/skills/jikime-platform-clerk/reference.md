...
- **jikime-lang-typescript**: TypeScript development patterns
- **jikime-domain-frontend**: React and Next.js integration
- **jikime-platform-supabase**: Supabase authentication
