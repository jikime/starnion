---
name: jikime-mobile-react-native
...
version: 1.0.0
tags: ["mobile", "react-native", "expo", "performance", "animation", "reanimated", "navigation"]
triggers:
  keywords: ["react native", "react-native", "expo", "mobile", "reanimated", "gesture handler", "flashlist", "legendlist", "native stack", "리액트 네이티브", "모바일"]
  phases: ["run"]
  agents: ["frontend"]
...
# Original source: Vercel React Native Skills (MIT License)
---
