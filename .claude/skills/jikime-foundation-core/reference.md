# jikime-foundation-core Reference
...
from jikime_foundation_core import TRUST5Validator
...
from jikime_foundation_core import SPECManager, DDDExecutor, DocsGenerator
...
from jikime_foundation_core import TaskAnalyzer, AgentRouter
...
from jikime_foundation_core import TokenMonitor, ContextOptimizer
...
jikime-trust check --all --verbose

# Token budget analysis
jikime-context analyze --show-breakdown

# Agent routing debug
jikime-agent route --task "description" --dry-run

# SPEC validation
jikime-spec validate SPEC-001 --format EARS
```

### Validation Utilities

```python
from jikime_foundation_core import diagnose
...
- TRUST 5 logs: `.jikime/logs/trust5/`
- SPEC artifacts: `.jikime/specs/`
- Agent execution logs: `.jikime/logs/agents/`
- Token usage history: `.jikime/logs/tokens/`
...
- JikiME-ADK Documentation: See project README
...
- jikime-foundation-claude - Claude Code integration patterns
- jikime-workflow-project - Project management with core principles
- jikime-workflow-testing - Testing workflows with TRUST 5
- jikime-workflow-templates - Template management integration
