  ...
  spec-validation:
    ...
    steps:
      ...
      - name: Validate SPEC format
        run: python .jikime/scripts/validate_spec.py
      - name: Check requirement traceability
        run: python .jikime/scripts/check_traceability.py
  ...
  ddd-implementation:
    ...
    steps:
      ...
      - name: Verify tests exist for all requirements
        run: python .jikime/scripts/verify_test_coverage_mapping.py
  ...
  quality-gates:
    ...
    steps:
      ...
      - name: Validate TRUST 5
        run: python .jikime/scripts/validate_trust5.py
```
