...
decision = splitter.should_split(".claude/skills/jikime-foundation-core/SKILL.md")
...
if decision["split_needed"]:
 ...
 ".claude/skills/jikime-foundation-core",
...
# Usage
organizer = SkillOrganizer(".claude/skills/jikime-foundation-core")
...
with open(".claude/skills/jikime-foundation-core/NAVIGATION.md", 'w') as f:
 f.write(navigation)
```
...
# Usage
discovery = ModuleDiscovery(".claude/skills/jikime-foundation-core")
...
- /jikime:3-sync - Documentation sync to modular structure

Memory:
- @.claude/skills/ - Standard skill location
- Skill("jikime-foundation-core") modules/ - Memory files following modular pattern
