# JikiME Foundation Core - Modules Directory

Purpose: Extended documentation modules for jikime-foundation-core skill, providing deep dives into each foundational principle.
...
This directory contains 9 comprehensive modules covering JikiME-ADK's foundational principles and execution rules:
...
Quick Access:
- SPEC generation (/jikime:1-plan)
- EARS format patterns
- DDD implementation (/jikime:2-run)
- Documentation sync (/jikime:3-sync)
...
Agent Catalog - Complete reference of JikiME-ADK's 26 specialized agents with 7-tier hierarchy.
...
Command Catalog - Complete reference for JikiME-ADK's 6 core commands in SPEC-First DDD workflow.

Quick Access:
- /jikime:0-project (Project init)
...
skill_path = Path(".claude/skills/jikime-foundation-core")
...
class ModuleSearch:
 ...
 modules_dir = Path(".claude/skills/jikime-foundation-core/modules")
 results = []
