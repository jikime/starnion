...
TRUST 5 is JikiME-ADK's comprehensive quality assurance framework enforcing five pillars:
...
# Validate skill
result = validator.validate_skill(".claude/skills/jikime-foundation-core")
...
if not result["valid"]:
 ...
 # Auto-split
 validator.auto_split_skill(".claude/skills/jikime-foundation-core")
...
# Usage
loader = ProgressiveContentLoader(".claude/skills/jikime-foundation-core")
...
- /jikime:3-sync - Create docs with layered structure
