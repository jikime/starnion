...
class SessionManager:
    ...
    def __init__(self, storage_path: str = ".jikime/sessions"):
    ...
    def prepare_for_clear(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "reload_files": [
                "CLAUDE.md",
                f".jikime/specs/{self.current_session.work_state.current_spec}.md"
            ]
        }
...
class AgentType(Enum):
    SPEC_BUILDER = "manager-spec"
    DDD_IMPLEMENTER = "manager-ddd"
    BACKEND = "backend"
    FRONTEND = "frontend"
    DOCS_MANAGER = "manager-docs"
    QUALITY_GATE = "manager-quality"
...
# Create handoff from manager-spec to manager-ddd
...
task_ctx = TaskContext(
    ...
    key_artifacts={
        "spec_document": ".jikime/specs/SPEC-001.md",
        "architecture": ".jikime/architecture/SPEC-001.mermaid"
    }
)
...
class ClearStrategy:
    ...
    def prepare_clear_context(
        ...
        return {
            ...
            "reload_sequence": [
                "CLAUDE.md",
                f".jikime/specs/{session.work_state.current_spec}.md",
...
analysis = Task(subagent_type="manager-spec", prompt="Analyze: user auth")
...
docs = Task(subagent_type="manager-docs", prompt="Generate docs")
