# jikime-foundation-context Reference
...
- After `/jikime:1-plan` completion
...
Workflow Sequence:
1. `/jikime:1-plan` execution
2. `/clear` (mandatory - saves 45-50K tokens)
3. `/jikime:2-run SPEC-XXX`
4. Multi-agent handoffs
5. `/jikime:3-sync SPEC-XXX`
...
- `jikime-foundation-claude`: Claude Code authoring and configuration
- `jikime-foundation-core`: Core execution patterns and SPEC workflow
- `jikime-workflow-project`: Project management and documentation
- `jikime-foundation-context`: Memory management and persistence
