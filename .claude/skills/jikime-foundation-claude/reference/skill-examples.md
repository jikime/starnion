...
```yaml
---
name: jikime-docs-api-generator
...
```yaml
---
name: jikime-code-comment-analyzer
...
```yaml
---
name: jikime-python-testing-expert
...
```yaml
---
name: jikime-modern-javascript-patterns
...
```yaml
---
name: jikime-security-analysis-expert
...
```yaml
---
name: jikime-workflow-automation-expert
