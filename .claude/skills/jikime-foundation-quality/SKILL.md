---
name: "jikime-foundation-quality"
...
aliases: ['jikime-foundation-quality']
updated: 2026-01-11
status: "active"
allowed-tools:
  - Read
...
- planner - Quality requirements planning
- manager-ddd - DDD implementation validation
...
- jikime-foundation-core - TRUST 5 framework reference
- jikime-workflow-ddd - DDD workflow validation
- jikime-workflow-testing - Testing patterns and quality
- jikime-domain-backend - Backend quality patterns
- jikime-domain-frontend - Frontend quality patterns

Commands:

- /jikime:2-run - DDD validation integration
- /jikime:3-sync - Documentation quality checks
