...
LOG_FILE="$PROJECT_ROOT/.jikime/logs/quality-gate.log"
CONFIG_FILE="$PROJECT_ROOT/.jikime/config/quality-config.yaml"
...
# Default values
PROJECT_PATH="src/"
OUTPUT_DIR=".jikime/reports/quality"
...
check_dependencies() {
    ...
    local python_deps=("jikime-foundation-quality")
...
Options:
  ...
  --output-dir DIR          Output directory for reports (default: .jikime/reports/quality)
