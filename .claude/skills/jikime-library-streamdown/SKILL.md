...
# Related Skills
related_skills:
  - jikime-library-vercel-ai-sdk    # Vercel AI SDK integration (useChat, streamText)
  - jikime-lang-typescript          # TypeScript patterns
  - jikime-framework-nextjs@16      # Next.js App Router
  - jikime-library-shadcn           # UI components
---
