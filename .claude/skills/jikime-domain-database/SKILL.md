...
- jikime-domain-backend - API integration and business logic
- jikime-foundation-core - Database migration and schema management
- jikime-workflow-project - Database project setup and configuration
- jikime-platform-supabase - Supabase database integration patterns
- jikime-lang-python - Python database patterns
- jikime-lang-typescript - TypeScript ORM patterns
...
- MongoDB 7.0+ as primary document store
