...
User Request
    ↓
/jikime:1-plan "feature1" "feature2" "feature3" --worktree
    ↓
...
│ /jikime:2-run │ /jikime:2-run │ /jikime:2-run │
└─────────────┴─────────────┴─────────────┘
    ↓
Worktree merge to main branch
    ↓
/jikime:3-sync SPEC-001 SPEC-002 SPEC-003
    ↓
...
```
/jikime:1-plan "database schema" --branch
    ↓
...
Database schema implemented
    ↓
/jikime:1-plan "backend API" --branch
    ↓
...
Backend API implemented
    ↓
/jikime:1-plan "frontend UI" --branch
    ↓
SPEC-003 created (depends on SPEC-002)
    ↓
/jikime:2-run SPEC-003
    ↓
...
- JikiME-ADK Plan-Run-Sync Workflow: Core methodology documentation
...
- DDD Best Practices: Test-Driven Development implementation guide
