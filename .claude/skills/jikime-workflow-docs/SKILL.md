...
Use Context7 MCP to look up Nextra documentation for comprehensive patterns.
...
Pattern for generating documentation from JikiME SPEC files:
...
Skills:
- jikime-lang-python - Python docstring conventions and typing
- jikime-lang-typescript - TypeScript/JSDoc documentation patterns
- jikime-domain-backend - API documentation for backend services
- jikime-workflow-project - Project documentation integration
...
Commands:
- /jikime:3-sync - Documentation synchronization with code changes
