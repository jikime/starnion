...
#### Running Scans
```bash
# Scan with JikiME-ADK rules
sg scan --config .claude/skills/jikime-tool-ast-grep/rules/sgconfig.yml
...
- **jikime-workflow-testing** - DDD integration, test pattern detection
- **jikime-foundation-quality** - TRUST 5 compliance, code quality gates
- **jikime-domain-backend** - API pattern detection, security scanning
- **jikime-domain-frontend** - React/Vue pattern optimization
- **jikime-lang-python** - Python-specific security and style rules
- **jikime-lang-typescript** - TypeScript type safety patterns
