  ...
  ast-grep:
    ...
    steps:
      ...
      - name: Run Security Scan
        run: sg scan --config .claude/skills/jikime-tool-ast-grep/rules/sgconfig.yml --format github
...
sg scan --config .claude/skills/jikime-tool-ast-grep/rules/sgconfig.yml --format compact
...
sg scan --config .claude/skills/jikime-tool-ast-grep/rules/sgconfig.yml --severity error
