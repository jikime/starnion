...
Integration Points:
- JikiME-ADK Workflow: Seamless integration with /jikime:1-plan, /jikime:2-run, /jikime:3-sync
...
JikiME-ADK Integration: Refer to jikime-adk-integration.md
- Plan Phase integration with /jikime:1-plan
- Development Phase integration with /jikime:2-run
- Sync Phase integration with /jikime:3-sync
...
### JikiME-ADK Workflow Integration

The worktree system integrates deeply with the JikiME Plan-Run-Sync workflow:
...
Development Phase (/jikime:2-run):
...
Detailed Reference: Refer to jikime-adk-integration.md for complete workflow patterns
...
For automatic SPEC worktree creation, integrate with /jikime:1-plan by configuring auto-creation in worktree settings. Refer to jikime-adk-integration.md for implementation details.
...
For team collaboration with shared registries, configure team registry settings with developer-specific worktree prefixes. Refer to jikime-adk-integration.md for coordination patterns.

---

## Sub-Module References

JikiME-ADK Integration (jikime-adk-integration.md):
- Complete /jikime:1-plan integration patterns
- DDD-aware /jikime:2-run integration
- Sync Phase automation with /jikime:3-sync
