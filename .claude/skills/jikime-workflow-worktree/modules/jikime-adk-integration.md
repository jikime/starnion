# JikiME-ADK Integration Module

Purpose: Detailed integration patterns for jikime-worktree with JikiME-ADK Plan-Run-Sync workflow including plan phase automation, DDD integration, and cleanup workflows.
...
JikiME-ADK Integration Points:
- /jikime:1-plan: Automatic worktree creation after SPEC generation
- /jikime:2-run: DDD execution in isolated worktree environment
- /jikime:3-sync: Worktree sync with documentation updates
- Cleanup: Automatic removal of merged worktrees

---

## Plan Phase Integration (/jikime:1-plan)
...
- Default: {repo}/.jikime/worktrees/{project-name}/SPEC-{id}
- Configurable via worktree_root setting

Creation Workflow:
1. SPEC is created with /jikime:1-plan
...
## Development Phase Integration (/jikime:2-run)
...
- Looks for .jikime/worktrees directory in path hierarchy
...
## Sync Phase Integration (/jikime:3-sync)
...
### JikiME Configuration Integration

Worktree settings in .jikime/config/config.yaml:
...
- worktree_root: Base directory for worktrees (default: {repo}/.jikime/worktrees)
...
Version: 1.0.0
Last Updated: 2026-01-06
Module: JikiME-ADK workflow integration patterns for Plan-Run-Sync phases
