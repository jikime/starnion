# jikime-workflow-templates Reference
...
from jikime_workflow_templates import TemplateManager
...
from jikime_workflow_templates import TemplateOptimizer

optimizer = TemplateOptimizer("/project/.jikime")
...
from jikime_workflow_templates import FeedbackTemplateGenerator
...
from jikime_workflow_templates import VersionManager
...
- Solution: Review conflicts in `.jikime/merge-conflicts/` and resolve manually
...
from jikime_workflow_templates import diagnose
...
- Template storage: `.claude/skills/jikime-workflow-templates/templates/`
- Backups: `.jikime/backups/templates/`
- Merge conflicts: `.jikime/merge-conflicts/`
- Version history: `.jikime/config/template-versions.json`
- Feedback templates: `.claude/skills/jikime-workflow-templates/modules/feedback-templates.md`
...
- JikiME-ADK Templates Guide: See `modules/code-templates.md`
