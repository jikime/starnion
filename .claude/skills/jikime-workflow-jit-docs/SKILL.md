...
triggers:
  ...
  agents: ["manager-docs", "manager-spec", "backend", "frontend"]
...
- Check .jikime/docs/ for project-specific documentation
- Check .jikime/specs/ for requirements and specifications
...
- planner: Documentation planning
- manager-spec: SPEC documentation
