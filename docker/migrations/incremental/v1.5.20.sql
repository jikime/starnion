-- v1.5.20.sql
-- Add report_task_runs table for tracking scheduler job executions and dead-task recovery
...
CREATE INDEX IF NOT EXISTS idx_report_task_runs_status
    ON report_task_runs (status);
