...
| 프로바이더 | 대표 모델 | 특징 |
|-----------|----------|------|
| **Google Gemini** | Gemini 2.5 Pro, Gemini 2.0 Flash | 무료 티어 제공, 긴 컨텍스트, 멀티모달 |
| **OpenAI** | GPT-4o, GPT-4o-mini | 범용 성능 우수, 다양한 모델 |
| **Anthropic** | Claude Sonnet 4.5, Claude Haiku 4.5 | 안전한 AI, 긴 컨텍스트 |
| **GLM/Z.AI** | GLM-4-Flash, GLM-4-Plus | 고성능 추론, 중국어 강점 |
| **Ollama** | Llama 3, Mistral, Qwen 등 | 로컬 실행, 무료 |
