...
| 提供商 | 主要模型 | 特点 |
|--------|---------|------|
| **Google Gemini** | Gemini 2.0 Flash、Gemini 1.5 Pro | 提供免费套餐，长上下文 |
| **OpenAI** | GPT-4o、GPT-4o-mini | 通用性强，模型选择多样 |
| **Anthropic** | Claude 3.5 Sonnet、Claude 3 Haiku | 安全 AI，长上下文 |
| **GLM/Z.AI** | GLM-4 | 高性能推理模型 |
| **Ollama** | Llama 3、Mistral 等 | 本地运行，免费 |
