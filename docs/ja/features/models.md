...
| プロバイダー | 主なモデル | 特徴 |
|------------|----------|------|
| **Google Gemini** | Gemini 2.5 Pro、Gemini 2.0 Flash | 無料枠あり、長いコンテキスト、マルチモーダル |
| **OpenAI** | GPT-4o、GPT-4o-mini | 汎用性が高く多様なモデル |
| **Anthropic** | Claude Sonnet 4.5、Claude Haiku 4.5 | 安全な AI、長いコンテキスト |
| **GLM/Z.AI** | GLM-4-Flash、GLM-4-Plus | 高性能推論、中国語に強い |
| **Ollama** | Llama 3、Mistral、Qwen など | ローカル実行、無料 |
